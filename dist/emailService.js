...
class EmailService {
    ...
    getThankYouTemplate(email, messageBody) {
        return `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    async sendThankYouEmail(email, suggestion) {
    ...
    async sendSuggestionToOwner(fromUser, suggestion) {
    ...
    async sendThankYouToUser(contact, suggestion) {
    ...
    async sendUpgradeEmail(email, tier) {
